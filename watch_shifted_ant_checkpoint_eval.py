...
def main():
    ...
    parser.add_argument("--shift_family", type=str, default="floor_friction")
    parser.add_argument("--shift_level", type=str, default="moderate_high")
    ...
    if args.nominal:
        ...
        print(f"Using shifted XML: {spec.generated_xml_path}")
